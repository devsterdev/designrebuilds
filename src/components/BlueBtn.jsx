...
const BlueBtn = () => {
  return (
    <div>
      <button className="font-custom relative overflow-hidden justify-center flex w-32 h-12 rounded-3xl border-radius text-white bg-blue-600 cursor-pointer transition-all duration-300 ease-in-out group hover:rounded-2xl active:scale-75 active:bg-blue-400">
